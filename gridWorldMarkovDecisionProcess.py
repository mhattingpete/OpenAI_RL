...
from gridworldGame.helper import *

from gridworldGame.gridworld import gameEnv
...
class Qnetwork:
    def __init__(self,h_size,rnn_cell,myScope):
        ...
        self.state_in = rnn_cell.zero_state(tf.shape(tf.ones(self.batch_size))[0], tf.float32)
...
class gridWorldMarkovDecisionProcess:
	def __init__(self):
		pass
...
if __name__ == '__main__':
	AI = gridWorldMarkovDecisionProcess()
	#AI.train()
	AI.test()
